# OpenAPI Initiative Landscape

This is WIP landscape for the OpenAPI Initiative. Right now, it is just the OpenAPI Initiative member organizations, but overtime will evolve to showcase the broader ecosystem. It is modeled after the Cloud Native Computing Foundation (CNCF) [landscape](https://landscape.cncf.io) and based on the same open-source code.
